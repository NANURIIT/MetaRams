const TB07040Sjs = (function () {
  ...
  function inputClear(){
    ...
    $("#TB07040S_prfdCorpIntx").val("0");   // 선급법인세
    $("#TB07040S_trtx").val(0);           // 거래세
    
    $("#TB07040S_ibPrdtTrDcd").val("82");
    $("#TB07040S_rfnDt").val("");
    $("#TB07040S_stdrExrt").val("1.0");
