...
public class IBIMS997BDTO {
    ...
    private BigDecimal     preJobCount;                            // 업무프로그램에 전달될 선행JOB 건수
    private BigDecimal     confirmJobCount;                        // 업무프로그램에 전달될 CONFIRM JOB 건수
    private BigDecimal     childPid;                               // CHILD프로세스 즉 업무프로그램의 PID
    private BigDecimal     runCount;                               // 프로그램이 수행된 횟수
